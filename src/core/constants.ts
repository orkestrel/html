...
export const IMPLIED_CLOSERS: Readonly<Record<string, readonly string[]>> = Object.freeze({
	p: BLOCK_ELEMENTS,
	li: Object.freeze(['li']),
	dt: Object.freeze(['dt', 'dd']),
	dd: Object.freeze(['dt', 'dd']),
	option: Object.freeze(['option', 'optgroup']),
	optgroup: Object.freeze(['optgroup']),
	rt: Object.freeze(['rt', 'rp']),
	rp: Object.freeze(['rt', 'rp']),
	td: Object.freeze(['td', 'th', 'tr', 'thead', 'tbody', 'tfoot']),
	th: Object.freeze(['td', 'th', 'tr', 'thead', 'tbody', 'tfoot']),
	tr: Object.freeze(['tr', 'thead', 'tbody', 'tfoot']),
	thead: Object.freeze(['thead', 'tbody', 'tfoot']),
	tbody: Object.freeze(['thead', 'tbody', 'tfoot']),
	tfoot: Object.freeze(['thead', 'tbody', 'tfoot']),
})
 ...
 */
export const CONTENT_ELEMENTS: readonly string[] = Object.freeze([
	'a',
	'b',
	'blockquote',
	'br',
 ...
 * one. Lookup uses a frozen own-property record, and the parser checks ownership before
 * reading so a hostile name such as `&constructor;` cannot reach an object prototype.
 * Every value is written as an escape so the table stays readable and verifiable in a diff.
 */
